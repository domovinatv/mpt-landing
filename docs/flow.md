...
flowchart TD
    ...
    hrBank -->|"Apple Pay / Google Pay · min 10 € (Revolutov limit) · 0 € (plaća Revolut)"| revolut
...
stateDiagram-v2
    [*] --> FUNDS_AT_HR_BANK
    FUNDS_AT_HR_BANK --> FUNDS_AT_REVOLUT : cardTopup (min 10 € Revolut, plaća Revolut)
...
5. **Gnosis Pay VISA grana** — virtualna kartica na vlastitom GP Safeu, punjenje EURe transferom, POS plaćanje (u pripremi)
